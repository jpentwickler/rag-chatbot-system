...
class VectorStore:
    ...
    def get_course_outline(self, course_title: str) -> Optional[Dict[str, Any]]:
        """
        Get complete course outline including title, link, and all lesson details.
        
        Args:
            course_title: Course title (supports partial matching)
            
        Returns:
            Dictionary with course metadata and lessons list, or None if not found
        """
        import json
        try:
